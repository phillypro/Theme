                ...
                switch( input.tagName.toLowerCase() ) {
					case 'select' : 
						input.addEventListener( 'change', function() { 
                          ...
                          if($(input).prop('selectedIndex') == $(input).attr('conditional')) {
                           $(fld).next().removeClass('skip');
                          }else{
                          $(fld).next().addClass('skip');
                          }
                          self._nextField();
